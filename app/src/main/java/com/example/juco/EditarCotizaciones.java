...
public class EditarCotizaciones extends AppCompatActivity {
    private ListView cotizacionesListView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_editar_cotizaciones);

        cotizacionesListView = findViewById(R.id.cotizacionesListView);

        // Realiza la solicitud HTTP en segundo plano
        new EditarCotizaciones.FetchCotizacionesTask().execute("http://juco.x10.mx/obtener_cotizaciones.php");
    }
    ...
    private class FetchCotizacionesTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                Toast.makeText(EditarCotizaciones.this, "Error al obtener datos", Toast.LENGTH_SHORT).show();
            }
        }
    }
            ...
            if ("success".equals(status)) {
                ...
                cotizacionesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        // Obtiene la cotización seleccionada
                        ...
                        Intent detalleIntent = new Intent(EditarCotizaciones.this, EditarCotizacionesUpdate.class);
                ...
                Toast.makeText(EditarCotizaciones.this, "Error en la respuesta del servidor", Toast.LENGTH_SHORT).show();
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
